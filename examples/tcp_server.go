...
func main() {
	...
	var err error
	var eh *exampleTcpHandler
	var ticker *time.Ticker

	// create the handler object
	eh = &exampleTcpHandler{}
...
func (eh *exampleTcpHandler) HandleCoils(req *modbus.CoilsRequest) (res []bool, err error) {
	if req.UnitId != 1 {
...
func (eh *exampleTcpHandler) HandleDiscreteInputs(req *modbus.DiscreteInputsRequest) (res []bool, err error) {
...
func (eh *exampleTcpHandler) HandleHoldingRegisters(req *modbus.HoldingRegistersRequest) (res []uint16, err error) {
	var regAddr uint16
...
func (eh *exampleTcpHandler) HandleInputRegisters(req *modbus.InputRegistersRequest) (res []uint16, err error) {
	var unixTs_s uint32
